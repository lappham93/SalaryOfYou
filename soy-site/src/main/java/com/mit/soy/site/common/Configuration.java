...
public class Configuration {
    ...
    static {
        APP_TITLE = MConfig.getConfig().getString("systeminfo.app-title", "soy site");
        ...
        APP_DOMAIN_HOME = APP_DOMAIN + "/soy/home";
        AVATAR_DEFAULT = APP_STATIC_DOMAIN + "/soy/cmsstatic/avatar2.png";
        IMG_DEFAULT = APP_STATIC_DOMAIN + "/soy/cmsstatic/default-image.jpg";
        IMG_LOGO = APP_STATIC_DOMAIN + "/soy/cmsstatic/soy-logo.png";
