...
package com.mit.augusta.admin.common;
...
public class Common {
    ...
    static{
        //publicUrl.add("/");
        publicUrl.add("/web2/admin/static");
        publicUrl.add("/web2/admin/deny");
        publicUrl.add("/web2/admin/login");
        publicUrl.add("/web2/admin/logout");
        publicUrl.add("/web2/admin/load/email");
        
        //saleAccessUrl.add("/web2/admin/repcode");
    ...
    public static String buildURICSV(String filename){
        String uri = Configuration.APP_DOMAIN + "/web2/admin/csv?f=" + filename;
        return uri;
    }
