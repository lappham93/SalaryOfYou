...
package com.mit.augusta.admin.app;
...
import com.mit.augusta.admin.handler.DenyHandler;
import com.mit.augusta.admin.handler.HomeHandler;
import com.mit.augusta.admin.handler.LoginHandler;
import com.mit.augusta.admin.handler.LogoutHandler;
...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        handler.addServletWithMapping(HomeHandler.class, "/web2/admin");
        handler.addServletWithMapping(HomeHandler.class, "/web2/admin/home");
        handler.addServletWithMapping(LoginHandler.class, "/web2/admin/login");
        handler.addServletWithMapping(LogoutHandler.class, "/web2/admin/logout");
        ...
        //static file
        ContextHandler resource_handler = new ContextHandler("/web2/admin/static");
