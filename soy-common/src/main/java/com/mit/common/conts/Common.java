...
public class Common {
    ...
    public static final String DOMAIN_CHAT_ROOM;
    public static final String DOMAIN_UPLOAD_ROOM;
    public static final String DOMAIN_POLLING_FEED;
    public static final String DOMAIN_COMMENT_FEED;
    public static final String DOMAIN_CHAT_LIVE;
    ...
    public static final String idGenChatLive = "idGenChatLive";
    
    static{
        DOMAIN_APP = ConfigUtils.getConfig().getString("system.domain", "http://bconnectapp.com");
        DOMAIN_FILE = ConfigUtils.getConfig().getString("system.domain-file", "http://115.79.45.86");
        DOMAIN_ADMIN = ConfigUtils.getConfig().getString("system.domain-admin", "http://admin.bconnectapp.com");
        DOMAIN_CHAT_ROOM = ConfigUtils.getConfig().getString("system.domain-chat-room", "ws://115.79.45.86:8998");
        DOMAIN_UPLOAD_ROOM = ConfigUtils.getConfig().getString("system.domain-upload-room", "ws://115.79.45.86:8997");
        DOMAIN_POLLING_FEED = ConfigUtils.getConfig().getString("system.domain-polling-feed", "http://115.79.45.86:8996");
        DOMAIN_COMMENT_FEED = ConfigUtils.getConfig().getString("system.domain-comment-feed", "ws://115.79.45.86:8996");
        DOMAIN_CHAT_LIVE = ConfigUtils.getConfig().getString("system.domain-chat-live", "ws://115.79.45.86:8995");
        ...
        APP_LINK = ConfigUtils.getConfig().getString("app-link", "bconnect://");
        ...
        mapPOType.put(POType.COLOR.getValue(), POType.COLOR.name().toLowerCase());
