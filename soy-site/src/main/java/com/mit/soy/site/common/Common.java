...
package com.mit.soy.site.common;
...
public class Common {
    ...
    static{
        ...
        publicUrl.add("/soy");
        publicUrl.add("/soy/");
        publicUrl.add("/soy/home");
        publicUrl.add("/soy/login");
        publicUrl.add("/soy/product");
        publicUrl.add("/soy/register");
        publicUrl.add("/soy/login/forgotpassword");
        publicUrl.add("/soy/register");
        publicUrl.add("/soy/sale-representatives");
        publicUrl.add("/soy/distributor");
        publicUrl.add("/soy/customer-testimonials");
        publicUrl.add("/soy/faq");
        publicUrl.add("/soy/contactus");
        publicUrl.add("/soy/delivery-policy");
        publicUrl.add("/soy/privacy-policy");
        publicUrl.add("/soy/terms-of-use");
        publicUrl.add("/soy/account/refund-policy");
