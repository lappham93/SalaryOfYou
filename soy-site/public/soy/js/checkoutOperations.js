...
$(function(){
    ...
    function copyBillingForm() {
        $('.cloneable').each(function() {
            ...
            $('#address\\.addressLine3').val($('#address\\.addressLine2').val());
            $('#address\\.addressLine2').val("");
            $('#address\\.addressLine2').prop('disabled', false);
        })
    }
...
//        $('#postal_code_alert_err').hide();
//        var postalCode = $('#shipping_info #address\\.postalCode').val();
//        if($.isNumeric(postalCode)){
//            $('#shipping_info').submit();
//        } else{
//            $('#postal_code_alert_err').show();
//            return false;
//        }
        $('#shipping_info').submit();
    });
    ...
    //(son_nd) disable ham xu ly mac dinh
