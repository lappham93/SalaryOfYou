 ...
 * @since Mar 21, 2016
 */
public class FeedPhotoClient {
    private static final Class _ThisClass = FeedPhotoClient.class;
	private static final Logger _Logger = LoggerFactory.getLogger(_ThisClass);
	private static final String _name = "feedphoto";
	private TClientPool.BizzConfig _bizzCfg;
    
    private static FeedPhotoClient instance = new FeedPhotoClient();
    
    private FeedPhotoClient(){
