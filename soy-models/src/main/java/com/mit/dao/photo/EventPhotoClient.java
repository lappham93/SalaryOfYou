 ...
 * @since Mar 21, 2016
 */
public class EventPhotoClient {
    private static final Class _ThisClass = EventPhotoClient.class;
	private static final Logger _Logger = LoggerFactory.getLogger(_ThisClass);
	private static final String _name = "eventphoto";
	private TClientPool.BizzConfig _bizzCfg;
    
    private static EventPhotoClient instance = new EventPhotoClient();
