...
package com.mit.augusta.admin.handler;

import com.eclipsesource.json.JsonObject;
import com.mit.augusta.admin.common.Common;
import com.mit.augusta.admin.common.Configuration;
import com.mit.augusta.admin.entities.LoginSession;
import com.mit.augusta.admin.entities.ROLE;
        ...
        try {
            ...
            if(!Common.publicUrl.contains(subPath)){
                ...
                if(!checkSession(req, resp)){
                    resp.sendRedirect(Configuration.APP_DOMAIN + "/web2/admin/login");
                    return;
                }
...
//            }
            ...
            if("/web2/admin".equalsIgnoreCase(svl)){
                dic.setVariable("MN_HOME", "active");
                dic.addSection("BC_HOME");
            } else if("/web2/admin/home".equalsIgnoreCase(svl)){
                dic.setVariable("MN_HOME", "active");
                dic.addSection("BC_HOME");
            } else if("/web2/admin/product".equalsIgnoreCase(svl)){
                dic.setVariable("MN_PRODUCT", "active");
                dic.addSection("BC_PRODUCT");
            } else if("/web2/admin/customer".equalsIgnoreCase(svl)){
                dic.setVariable("MN_CUSTOMER", "active");
                dic.addSection("BC_CUSTOMER");
            } else if("/web2/admin/order".equalsIgnoreCase(svl)){
                dic.setVariable("MN_ORDER", "active");
                dic.addSection("BC_ORDER");
            } else if("/web2/admin/repcode".equalsIgnoreCase(svl)){
                dic.setVariable("MN_REPCODE", "active");
                dic.addSection("BC_REPCODE");
            } else if("/web2/admin/promotion".equalsIgnoreCase(svl)){
                dic.setVariable("MN_PROMOTION", "active");
                dic.addSection("BC_PROMOTION");
            } else if("/web2/admin/banner".equalsIgnoreCase(svl)){
                dic.setVariable("MN_BANNER", "active");
                dic.addSection("BC_BANNER");
            } else if("/web2/admin/report".equalsIgnoreCase(svl)){
                dic.setVariable("MN_REPORT", "active");
                dic.addSection("BC_REPORT");
            } else if("/web2/admin/notification".equalsIgnoreCase(svl)){
                dic.setVariable("MN_NOTIFICATION", "active");
                dic.addSection("BC_NOTIFICATION");
            } else if("/web2/admin/email".equalsIgnoreCase(svl)){
                dic.setVariable("MN_EMAIL", "active");
                dic.addSection("BC_EMAIL");
            } else if("/web2/admin/distributor".equalsIgnoreCase(svl)){
